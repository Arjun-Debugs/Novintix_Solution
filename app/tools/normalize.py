...
def normalize_record(record: dict, fx_rates: dict = None) -> NormalizedRecord:
    if fx_rates is None:
    ...
    # Strip any extra text from currency e.g. "USD" in "1200 USD" (already handled by clean_amount_string but nice to keep clean)
